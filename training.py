...
from models.resnet import resnet50, resnet_change_ratio, resnet_3blocks, resnet29, resnet_patchify
from models.resnext import ResNext, ResNext_increasedim, ResNext_InvertedBottleneck
from models.convnext import ConvNeXt, ConvNeXt_kernel7
...
def get_args_parser():
    ...
    parser.add_argument('--model', default=None,
                        choices=['Resnet50', 'resnet29', 'changed_ratio', 'resnet_3blocks', 'transformer_stem', 'ResNext',
                                 'ResNext_invertedBottleneck', 'ConvNeXt', 'ConvNext_kernel7'],
                        type=str, help='ImageNet dataset path, choices=[Resnet50, resnet29, changed_ratio, resnet_3blocks, '
                                       'transformer_stem, ResNext, ResNext_invertedBottleneck, ConvNeXt, ConvNext_kernel7]')
...
def main(args):
    ...
    if args.model == 'Resnet50':
        net = resnet50(100)
    elif args.model == 'resnet29':
        net = resnet29(100)
    elif args.model == 'changed_ratio':
        net = resnet_change_ratio(100)
    elif args.model == 'resnet50_3blocks':
        net = resnet_3blocks(100)
    elif args.model == 'transformer_stem':
        net = resnet_patchify(100)
    elif args.model == 'ResNext':
        net = ResNext(100)
    elif args.model == 'Resnext50_increasedim':
        net = ResNext_increasedim(100)
    elif args.model == 'ResNext_invertedBottleneck':
        net = ResNext_InvertedBottleneck(100)
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser('ConvNeXt training script', parents=[get_args_parser()])
